...
function AdminLiftsNew() {
   ...
   async function handleCreateLift(event) {
        ...
        const response = await createLift(powerlifter_id, meet_id, division, place, weight, bench1, bench2, bench3, best3bench,
    ...
    return (
        <div className="add-lift cont">
            <form className="auth form" onSubmit={handleCreateLift}>
                <h1 className="auth title tac">Create Lift</h1>

...
CREATE TABLE `Scores` (
    ...
    UNIQUE KEY (`powerlifter_id`, `meet_id`, `wilks`, `mccullough`, `glosbrenner`, `ipfp_points`),
    FOREIGN KEY (`powerlifter_id`) REFERENCES `Powerlifter`(`id`) ON DELETE CASCADE,
    FOREIGN KEY (`meet_id`) REFERENCES `Meet`(`meet_id`) ON DELETE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=latin1 AUTO_INCREMENT=1 ;
...
CREATE TABLE `Person_Meet_Info` (
    ...
    `place` VARCHAR(2),
    PRIMARY KEY (`powerlifter_id`, `meet_id`, `division`, `weight_class`, `place`),
    FOREIGN KEY (`powerlifter_id`) REFERENCES `Powerlifter`(`id`) ON DELETE CASCADE,
    FOREIGN KEY (`meet_id`) REFERENCES `Meet`(`meet_id`) ON DELETE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=latin1 AUTO_INCREMENT=1 ;
...
CREATE TABLE `Lifts` (
    ...
    `totalkg` DECIMAL(5,2),
    UNIQUE KEY (`powerlifter_id`, `meet_id`, `bench1kg`, `bench2kg`, `bench3kg`, `best3benchkg`, `squat1kg`, `squat2kg`, `squat3kg`, `best3squatkg`, `deadlift1kg`, `deadlift2kg`, `deadlift3kg`, `best3deadliftkg`, `totalkg`),
    FOREIGN KEY (`powerlifter_id`) REFERENCES `Powerlifter`(`id`) ON DELETE CASCADE,
    FOREIGN KEY (`meet_id`) REFERENCES `Meet`(`meet_id`) ON DELETE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=latin1 AUTO_INCREMENT=1 ;
...
LOCK TABLES `Powerlifter_Meets` WRITE;
...
LOCK TABLES `Person_Meet_Info` WRITE;

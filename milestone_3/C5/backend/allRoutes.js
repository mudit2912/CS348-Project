...
router.post('/admin/lifts/new', async function (req, res, next) {
  dbpool.getConnection((connect_err, conn) => {
    ...
    const username_query_str = 'SELECT id FROM User WHERE username = ?;';
    conn.query(username_query_str, [req.user.username], (user_err, user_result, user_fields) => {
      if (user_err || user_result === null || user_result[0] === null) return res.status(500).json({msg: 'User error.'});
      ...
      conn.query(id_query_str, [user_id],
        (id_query_err, id_result, id_fields) => {
          ...
          const meet_query_str = 'Select * from Meet where meet_id = ?;';
          conn.query(meet_query_str, [req.body.meet_id],
            (meet_query_err, meet_result, meet_fields) => {
              if (meet_query_err) return res.status(500).json({ msg: 'Error querying Meet table.' });
              if (meet_result.length == 0) return res.status(404).json({ msg: 'Meet does no exist' });

              const query_str = 'INSERT INTO Scores(powerlifter_id, meet_id, wilks, mccullough, glossbrenner, ipfp_points) VALUES(?, ?, ?, ?, ?, ?);';
              conn.query(query_str, [user_id, req.body.meet_id, req.body.wilks, req.body.mccullough, req.body.glossbrenner, req.body.ipfp_points],
                (query_err, result, fields) => {
                  ...
                  conn.query(query_str, [user_id, req.body.meet_id, req.body.bench1kg, req.body.bench2kg, req.body.bench3kg, req.body.best3benchkg, req.body.squat1kg, req.body.squat2kg, req.body.squat3kg, req.body.best3squatkg, req.body.deadlift1kg, req.body.deadlift2kg, req.body.deadlift3kg, req.body.best3deadliftkg, req.body.totalkg],
                    (query_err, result, fields) => {
                      ...
                      conn.query(query_str, [user_id, req.body.meet_id, req.body.divison, req.body.division, req.body.weight_class, req.body.place],
                        (query_err, result, fields) => {
      ...
      (id_query_err, id_result, id_fields) => {
        ...
        conn.query(id_query_str, [req.body.meet_id],
          (id_query_err, id_result, id_fields) => {
            ...
            const query_str = 'INSERT INTO Scores(powerlifter_id, meet_id, wilks, mccullough, glossbrenner, ipfp_points) VALUES(?, ?, ?, ?, ?, ?);';
            conn.query(query_str, [pl_id, req.body.meet_id, req.body.wilks, req.body.mccullough, req.body.glossbrenner, req.body.ipfp_points],
              (query_err, result, fields) => {
                console.log()
                if (query_err) return res.status(500).json({ msg: 'Error Inserting into Scores table.' });
                ...
                conn.query(query_str, [pl_id, req.body.meet_id, req.body.bench1kg, req.body.bench2kg, req.body.bench3kg, req.body.best3benchkg, req.body.squat1kg, req.body.squat2kg, req.body.squat3kg, req.body.best3squatkg, req.body.deadlift1kg, req.body.deadlift2kg, req.body.deadlift3kg, req.body.best3deadliftkg, req.body.totalkg],
                  (query_err, result, fields) => {
                    ...
                    const query_str = 'INSERT INTO Person_Meet_Info (powerlifter_id, meet_id, division, weight_class, place) VALUES(?, ?, ?, ?, ?);';
                    conn.query(query_str, [pl_id, req.body.meet_id, req.body.division, req.body.weight_class, req.body.place],
                      (query_err, result, fields) => {
                        if (query_err) return res.status(500).json({ msg: 'Error Inserting into Person_Meet_Info table.' });
                        return res.status(200).json({ success: true });
                      }
